...
def upload_file():
    ...
    feature, sift_img = sift(image, orientations=9, pixels_per_cell=(8, 8), cells_per_block=(1, 1), visualize=True, channel_axis=-1)
...
if __name__ == "__main__":
    ...
    filename = "/Users/ronakshakari/Desktop/project/model/sift_model.pickle"
    ...
    window.title('Sift Gender Classification')
